...
@EnableJpaRepositories(
        basePackages = {"com.github.springbootproject.repository.items", "com.github.springbootproject.repository.storeSales"},
...
public class JpaConfig1 {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean1(@Qualifier("dataSource1")DataSource dataSource) {
        ...
        em.setPackagesToScan("com.github.springbootproject.repository.items", "com.github.springbootproject.repository.storeSales");
